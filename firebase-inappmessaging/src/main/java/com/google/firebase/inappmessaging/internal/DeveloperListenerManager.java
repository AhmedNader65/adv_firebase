...
public class DeveloperListenerManager {
  ...
  private final Map<FirebaseInAppMessagingClickListener, ClicksExecutorAndListener>
      registeredClickListeners = new HashMap<>();
  private final Map<FirebaseInAppMessagingDismissListener, DismissExecutorAndListener>
      registeredDismissListeners = new HashMap<>();
  private final Map<FirebaseInAppMessagingDisplayErrorListener, ErrorsExecutorAndListener>
      registeredErrorListeners = new HashMap<>();
  private final Map<FirebaseInAppMessagingImpressionListener, ImpressionExecutorAndListener>
      registeredImpressionListeners = new HashMap<>();

  private static final BlockingQueue<Runnable> mCallbackQueue = new LinkedBlockingQueue<>();
